...
| `xStreamBufferSendFromISR` | ISR 发送 | ✅ | ❌ |
| `xStreamBufferReceive` | 接收字节流 | ❌ | ✅ |
| `xStreamBufferReceiveFromISR` | ISR 接收 | ✅ | ❌ |
| `xStreamBufferBytesAvailable` | 查询可用字节 | ✅ | ❌ |
| `xStreamBufferSpacesAvailable` | 查询剩余空间 | ✅ | ❌ |
| `xStreamBufferReset` | 复位 | ❌ | ❌ |
| `xStreamBufferIsFull` | 判断是否满 | ✅ | ❌ |
| `xStreamBufferIsEmpty` | 判断是否空 | ✅ | ❌ |
...
| `xMessageBufferSendFromISR` | ISR 发送消息 | ✅ | ❌ |
| `xMessageBufferReceive` | 接收消息 | ❌ | ✅ |
| `xMessageBufferReceiveFromISR` | ISR 接收消息 | ✅ | ❌ |
| `xMessageBufferReceiveLength` | 查询下一条消息长度 | ✅ | ❌ |
| `xMessageBufferReset` | 复位 | ❌ | ❌ |
| `xMessageBufferIsFull` | 判断是否满 | ✅ | ❌ |
| `xMessageBufferIsEmpty` | 判断是否空 | ✅ | ❌ |
