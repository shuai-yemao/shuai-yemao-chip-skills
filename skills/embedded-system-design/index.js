...
class EmbeddedSystemDesignPlugin {
  constructor() {
    this.name = 'embedded-system-design';
    this.version = '1.0.0';
    this.skills = {};
    this.config = {};
  }
  ...
  async loadSkills(skillsDir) {
    const skillDirs = ['lowpower-design', 'bootloader-design', 'ota-update-system', 'chip-architecture'];
...
module.exports = new EmbeddedSystemDesignPlugin();
