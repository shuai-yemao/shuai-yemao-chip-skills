...
class EmbeddedMcuPlugin {
  constructor() {
    this.name = 'embedded-mcu';
    this.version = '1.0.0';
    this.skills = {};
    this.config = {};
  }
  ...
  async loadSkills(skillsDir) {
    const skillDirs = [
      ...
      'arm-core-registers', 'arm-memory-architecture', 'arm-interrupt-exception',
      'mcu-peripheral-registers', 'build-idf', 'flash-idf'
    ];
...
module.exports = new EmbeddedMcuPlugin();
